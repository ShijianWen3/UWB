...
private slots:
    ...
    //add by ec
    void checkTagWarnClicked(int state);
private:
...
//    void updateAncAndLabel(int r,bool update,double x, double y,double z);
    void updatedata();
    bool checkAnchorStatus(int r);
    ...
    //Q3DSurface *series;  //散点序列
    QScatterDataArray *ancDataArray;
    QWidget *container;
