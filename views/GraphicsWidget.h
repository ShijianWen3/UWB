...
public:
    ...
    enum AnchorColumn{
        ...
        AnchorColumnGroup = 0,   ///< 64 bit address of the anchor (uint64)
        AnchorColumnID,
        AnchorColumnStatus,
        AnchorColumnX,        ///< X coordinate (double)
        AnchorColumnY,        ///< Y coordinate (double)
        AnchorColumnZ,        ///< Z coordinate (double)
        AnchorColumnIP,
        AnchorColumnMAC
    };
    ...
    //add by ec
    void addNewAnchorG(quint64 ancId, int anchindex, int groupid, bool show);
    ...
    QGraphicsSimpleTextItem *m_areaText;
...
signals:
    ...
    //add by ec
    void updateGroupID(QString ip, int GroupNo);
    void sendTagWarnCommand(int tagidA, bool status);
...
public slots:
    ...
    void tagRange(quint64 tagId, quint64 aId, double range,double rx_power);
    ...
    // add by ec
    void handleTableUpdate(QList<BaseStation> &data);
    double calculateDistance(double x1, double y1, double x2, double y2);
    void checkAndUpdateStatus();
    //add by ec
    void checktagwarn(int state, int warnsize);
