...
class ViewSettings : public QObject
{
    ...
    Q_PROPERTY(double tagSize READ tagSize WRITE setTagSize NOTIFY tagSizeChanged)
    Q_PROPERTY(int canvesFontSize READ canvesFontSize WRITE setCanvesFontSize NOTIFY canvesFontSizeChanged)
...
public:
    ...
    void setTagSize(double newTagSize);

    int canvesFontSize() const;
    void setCanvesFontSize(int newCanvesFontSize);
...
signals:
    ...
    void canvesFontSizeChanged();

    void fontSizeChangedeSignal(int size);
