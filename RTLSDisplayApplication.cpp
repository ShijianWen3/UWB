...
RTLSDisplayApplication::RTLSDisplayApplication(int &argc, char **argv) : QApplication(argc, argv)
{
    ...
    //add by ec
    QObject::connect(_client, SIGNAL(anchPosG(quint64,int,int,double,double,double,bool,bool)), graphicsWidget(), SLOT(anchPosG(quint64,int,int,double,double,double,bool, bool)));
    ...
    QObject::connect(_client, SIGNAL(tag3DPos(quint64,double,double,double)), viewSettingsWidget(), SLOT(tag3DPos(quint64,double,double,double)));
    ...
    QObject::connect(_client, SIGNAL(tagRange(quint64,quint64,double,double)), graphicsWidget(), SLOT(tagRange(quint64,quint64,double,double)));
    QObject::connect(_client, SIGNAL(updateAnchorList3D(int,bool,bool,double,double,double)), viewSettingsWidget(), SLOT(updateAnchorList3D(int,bool,bool,double,double,double)));
    ...
    //add by ec
    //QObject::connect(_client, SIGNAL(updateAnchorTable(const QList<BaseStation>)), graphicsWidget(), SLOT(handleTableUpdate(const QList<BaseStation>)));
    QObject::connect(_client,  &RTLSClient::updateAnchorTable, graphicsWidget(), &GraphicsWidget::handleTableUpdate);
    QObject::connect(graphicsWidget(), &GraphicsWidget::updateGroupID, _client, &RTLSClient::sendGroudIDCommandToBaseStations);
    //add by ec
    QObject::connect(graphicsWidget(), &GraphicsWidget::sendTagWarnCommand, _client, &RTLSClient::sendTagWarnCommandToBaseStations);
    //add end
...
ViewSettingsWidget *RTLSDisplayApplication::viewSettingsWidget()
{
